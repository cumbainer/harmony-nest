...
const SearchResultItem = ({id, type, genres, ownerName, image, title, authors}: Props) => {
    ...
    return (
        <li className="flex bg-none hover:bg-sky-700 p-2 cursor-pointer" onClick={handleClick}>
